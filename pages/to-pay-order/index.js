...
Page({
  ...
  createOrder: function (e) {
    ...
    HalgaiAPI.orderCreate(postData).then(function (res) {
      ...
      postJsonString.keyword2 = {
        value: res.data.amountReal + HalgaiI18.tojs0003,
        color: '#173177'
      }
      ...
      postJsonString.keyword4 = {
        value: HalgaiI18.tojs0004,
        color: '#173177'
      }
      postJsonString.keyword5 = {
        value: HalgaiI18.tojs0005,
        color: '#173177'
      }
  ...
  initShippingAddress: function () {
    var that = this;
    HalgaiAPI.defaultAddress(wx.getStorageSync('token')).then(function (res) {
      if (res.code == 0) {
        that.setData({
